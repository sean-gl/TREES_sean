...
2.0	canopy_height, m
4.5	lai_at_full_canopy_height   [sean] changing to ?.  Default = 4.5
...
454.83 58.0 100.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2
...
4.22 2.78 3.0 e_at_saturated_kl
...
1.942 0.9 1.5 ax_Shoot-b_value_(weibull)  [sean]  can't we use the same value for all?
2.128 0.9 1.5 ax_Shoot-c_value_(weibull)
1.942 0.9 1.5 lat_Shoot-b_value_(weibull)
2.128 0.9 1.5 lat_Shoot-c_value_(weibull)
1.942 1.5 ax_Root-b_value_(weibull)
2.128 1.5 ax_Root-c_value_(weibull)
1.942 1.383 1.5 lat_Root-b_value_(weibull)
2.128 1.48 1.5 lat_Root-c_value_(weibull)
...
0.16 0.0800 0.2 kea, m3 d-1 gC-1 (for exudates)
...
1 0 1 useHydraulics [sean] tu0ning off (default = 1 0 1)
0 0 1 useInputStress
1 0 0 useRefilling [sean] setting to zero (no refill?) not doing anything

...
454.83 58.0 100.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2 [sean] default = 454.83
...
6.00 2.78 3.0 e_at_saturated_kl [sean] default=4.22 2.78 3.0
...
0.09 silt_fraction [sean] default=0.09
0.17 clay_fraction [sean] default=0.17
...
1.942 0.9 1.5 ax_Shoot-b_value_(weibull)    [sean] default= 1.942 0.9 1.5
2.128 0.9 1.5 ax_Shoot-c_value_(weibull)    [sean] default= 2.128 0.9 1.5
1.942 0.9 1.5 lat_Shoot-b_value_(weibull)   [sean] default= 1.942 0.9 1.5
2.128 0.9 1.5 lat_Shoot-c_value_(weibull)   [sean] default= 2.128 0.9 1.5
1.942 1.5 ax_Root-b_value_(weibull)         [sean] default= 1.942 1.5
2.128 1.5 ax_Root-c_value_(weibull)         [sean] default= 2.128 1.5
1.942 1.383 1.5 lat_Root-b_value_(weibull)  [sean] default= 1.942 1.383 1.5
